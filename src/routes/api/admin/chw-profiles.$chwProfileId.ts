...
import { chwProfileUpdateSchema, deleteReasonSchema } from "@/lib/admin-schemas";
  ...
  server: {
    handlers: {
      ...
      DELETE: async ({ request, params }) => {
        ...
        try {
          const id = await deleteChwProfile(params.chwProfileId, parsed.data.reason, claims.sub);
